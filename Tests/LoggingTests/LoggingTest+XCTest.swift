...
extension LoggingTest {
    static var allTests: [(String, (LoggingTest) -> () throws -> Void)] {
        return [
            ...
            ("testLoggingCallsMetadataProviderWithExplicitlyPassedBaggage", testLoggingCallsMetadataProviderWithExplicitlyPassedBaggage),
            ...
            ("testLoggingPrefersExplicitBaggageOverTaskLocal", testLoggingPrefersExplicitBaggageOverTaskLocal),
            ("testLoggingWithExplicitlyPassedNilBaggageDoesNotPickUpTaskLocalBaggage", testLoggingWithExplicitlyPassedNilBaggageDoesNotPickUpTaskLocalBaggage),
