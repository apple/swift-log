...
enum AttrA: Int64, Logger.MetadataAttributeKey {
    case a1 = 1
    case a2 = 2
}

enum AttrB: Int64, Logger.MetadataAttributeKey {
    case b1 = 1
    case b2 = 2
}

enum AttrC: Int64, Logger.MetadataAttributeKey {
    case c1 = 1
    case c2 = 2
}

enum AttrD: Int64, Logger.MetadataAttributeKey {
    case d1 = 1
    case d2 = 2
}

enum AttrE: Int64, Logger.MetadataAttributeKey {
    case e1 = 1
    case e2 = 2
}
