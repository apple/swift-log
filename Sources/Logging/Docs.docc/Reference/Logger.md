...
- ``trace(_:error:attributedMetadata:source:file:function:line:)``
...
- ``debug(_:error:attributedMetadata:source:file:function:line:)``
...
- ``info(_:error:attributedMetadata:source:file:function:line:)``
...
- ``notice(_:error:attributedMetadata:source:file:function:line:)``
...
- ``warning(_:error:attributedMetadata:source:file:function:line:)``
...
- ``error(_:error:attributedMetadata:source:file:function:line:)``
...
- ``critical(_:error:attributedMetadata:source:file:function:line:)``
...
- ``log(level:_:error:attributedMetadata:source:file:function:line:)``
- ``Level``
- ``Message``
- ``Metadata``
...
### Attributed metadata types

- ``MetadataAttributeKey``
- ``MetadataValueAttributes``
- ``AttributedMetadataValue``
- ``AttributedMetadata``
