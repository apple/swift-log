...
| [MahdiBM/DiscordBM](https://github.com/MahdiBM/DiscordBM) | a Discord package containing a standalone [DiscordLogger library](https://github.com/MahdiBM/DiscordBM/blob/discord-logger/README.md#discord-logger) |
